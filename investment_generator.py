# Automating Investment Report Generation
...
# Add these lines before initializing the LLM
nest_asyncio.apply()
...
def main():
    ...
    st.set_page_config(page_title="Investment Report Generator", page_icon=None, layout="centered", initial_sidebar_state="auto", menu_items=None)
